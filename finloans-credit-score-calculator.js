document.getElementById('credit-score-estimator').addEventListener('submit', function (e) {
    ...
    const url = "https://script.google.com/macros/s/AKfycbx_7ZB2JJvEHHikkaaIp3FYrstjWpHsdYKGckk_uFbhWy4ART6QjUmAoKyO7ZlmYH33Tw/exec"; // Replace with your Google Apps Script Web App URL
    const data = {
